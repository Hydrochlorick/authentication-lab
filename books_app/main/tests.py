...
class MainTests(unittest.TestCase):
    ...
    def test_book_detail_logged_out(self):
        ...
        self.assertIn("1960", response_text)
    ...
    def test_create_author(self):
        ...
        our_post = {
            ...
            "biography": "He's crazy af"
        }
        self.app.post('/create_author', data=our_post)

        # Verify that the author was updated in the database
        created_author = Author.query.filter_by(name="Mark Danielewski").one()
        self.assertIsNotNone(created_author)
        self.assertEqual(created_author.name, "Mark Danielewski")
    ...
    def test_create_genre(self):
        ...
        self.app.post('/create_genre', data=our_genre)

        # Verify that the genre was updated in the database
        created_genre = Genre.query.filter_by(name="Psychological Thriller").one()
        self.assertIsNotNone(created_genre)
        self.assertEqual(created_genre.name, "Psychological Thriller")
